...
inline const std::filesystem::path kRandomSymbolPath = kTestDir / "random_symbols/";
...
inline const std::filesystem::path kKonstitucijaPath = "konstitucija.txt";
inline const std::filesystem::path kResultsPath = "results/";